...
%package -n ironic-python-agent-doc
Summary:    Documentation for ironic python agent.
Group:      Documentation
Provides:   ironic-python-agent-doc = %{upstream_version}

%description -n ironic-python-agent-doc
...
# TODO(trown) add egg-info once the agent is released on pypi

%files -n ironic-python-agent-doc
%doc doc/source
%license LICENSE
...
%changelog
* Wed Jun 22 2016 Haikel Guemar <hguemar@fedoraproject.org> 1.0.4-1
- Update to 1.0.4

* Fri Jun 17 2016 Haikel Guemar <hguemar@fedoraproject.org> 1.0.3-1
- Update to 1.0.3
